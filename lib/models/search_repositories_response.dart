...
//
//     final searchRepositoriesResponse = searchRepositoriesResponseFromJson(jsonString);

import 'dart:convert';

SearchRepositoriesResponse searchRepositoriesResponseFromJson(String str) =>
    SearchRepositoriesResponse.fromJson(json.decode(str));

String searchRepositoriesResponseToJson(SearchRepositoriesResponse data) =>
...
enum DefaultBranch { MASTER, GH_PAGES, MAIN }
